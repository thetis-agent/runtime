/** Enforce the trusted source budget while reporting excluded documentation; ADR 0039, proposal §10. */
...
process.stdout.write(`${JSON.stringify({ measurement: 'kernel-source-size', lines, physicalLines, commentLines, bytes, maximumLines: limits.kernelLines, files })}\n`);
