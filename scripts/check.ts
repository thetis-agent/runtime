...
async function shell(): Promise<number> {
  const scripts = ['install.sh', '.github/scripts/verify.sh', '.github/scripts/kernel-boundary.sh', '.github/scripts/prepare-runner.sh', '.github/scripts/install-smoke.sh', '.github/scripts/merge-coverage.sh', '.github/scripts/finalize-ci.sh'];
