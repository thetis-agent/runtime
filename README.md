...
| `packages/` | Git submodule with all packages: `kernel`, `userspace-agent`, `provider-openrouter`, `prompt-cache`, `marketplace`, `harness-core`, `tool-exec`, `gateway-cli`, `gateway-web`. |
| `docs/` | Documentation. |
