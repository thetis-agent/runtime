...
| `packages/` | Git submodule with all packages: `kernel`, `userspace-agent`, `provider-openrouter`, `harness-core`, `tool-exec`, `gateway-cli`. |
| `docs/` | Documentation. |
...
See [docs/08-cli.md](docs/08-cli.md).
