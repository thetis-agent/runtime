...
```sh
export THETIS_NODE=/home/thetis/.nvm/versions/node/v24.18.0/bin/node
...
The development checkout is `/srv/thetis/runtime` beside
`/srv/thetis/packages`. `/opt/zero` is the installation target;
