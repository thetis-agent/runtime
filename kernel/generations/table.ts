...
export const transitions: readonly Transition[] = [
  ...
  { from: 'PROBING', event: 'healthy', guard: 'healthy', to: 'SWITCHING', effects: ['adopt-copy'] },
  { from: 'SWITCHING', event: 'repointed', guard: 'atomic', to: 'DRAINING', stop: false, effects: ['fence', 'route-new-connections'] },
  { from: 'SWITCHING', event: 'repointed', guard: 'atomic', to: 'LIVE', stop: true, effects: ['fence', 'stop-old', 'route-new-connections', 'env.updated'] },
