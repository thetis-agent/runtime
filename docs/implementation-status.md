...
- Node 24.18.0 is installed at
  `/home/thetis/.nvm/versions/node/v24.18.0/bin/node`; shell Node is 18.20.4.
...
```sh
/home/thetis/.nvm/versions/node/v24.18.0/bin/node scripts/check.ts
systemd-run --user --scope --quiet -p MemoryMax=512M -p TasksMax=64 -p CPUQuota=100% /home/thetis/.nvm/versions/node/v24.18.0/bin/node /opt/zero/scripts/test.ts
```
