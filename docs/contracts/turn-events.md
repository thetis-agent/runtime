...
interface Context {
  sections: {
    system:  Message[];    // stored prefix; read-only to iteration hooks (implementation note 0022)
...
appends only to harness or history (implementation note 0022); it cannot reorder sections
