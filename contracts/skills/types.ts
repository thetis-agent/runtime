...
export type Entry = { "id": Id; "pack": string; "version": Version; "path": string; "contentHash": Hash; "universal": boolean; "body"?: string; "score"?: number; "how"?: "dense" | "lexical" | "fusion" | "parent-of-match" | "whole-corpus" | "universal" | "activated"; [key: string]: unknown; };
