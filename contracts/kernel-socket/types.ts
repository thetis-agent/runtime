...
export type Method = "session.list" | "session.create" | "session.submit" | "session.subscribe" | "session.cancel" | "session.rename" | "session.archive" | "profile.get" | "secret.has" | "package.register" | "health.probe" | "usage.report" | "token.whois" | "session.whois" | "install" | "snapshot" | "prune" | "results.submit" | "env.status" | "env.logs" | "env.reset" | "default.prepare" | "default.set" | "identity.assert" | "secret.set";
