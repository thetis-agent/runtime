...
export type SessionRenameParams = { "conversation": string; "title": string; [key: string]: unknown; };
export type SessionArchiveParams = { "conversation": string; "archived": boolean; [key: string]: unknown; };
export type SessionChoicesParams = { [key: string]: unknown; };
export type SessionChooseParams = { "conversation": string; "model"?: string; "mode"?: "agent" | "plan"; [key: string]: unknown; };
